...
subprojects {
    if (file("src/main/kotlin").isDirectory || file("src/main/resources").isDirectory) {
        ...
        dependencies {
            ...
            constraints {
                implementation(rootProject.libs.snakeyaml) { because("Vulnerability in version 1.31") }
                implementation(rootProject.libs.jackson.databind) { because("Vulnerability in version 2.13.2.1") }
            }
